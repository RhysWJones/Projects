        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FuelId = table.Column<long>(nullable: true),
                    TransmissionId = table.Column<long>(nullable: true),
                    VehicleImageSource = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Vehicles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Vehicles_Fuel_FuelId",
                        column: x => x.FuelId,
                        principalTable: "Fuel",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LateReturn = table.Column<bool>(nullable: false),
                    StartHalfDay = table.Column<bool>(nullable: false),
                    EndHalfDay = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookingId1 = table.Column<long>(nullable: true),
                    EquipmentId1 = table.Column<long>(nullable: true)
                },
                constraints: table =>
                {
