...
public abstract class Vehicle
{
    ...
    public Vehicle(String manufacturer, String model, String vehicleIdentificationNumber, String manufactureDate, char taxBand, double cost)
    {
    ...
    public String co2Emissions(char taxBand)
    {
        ...
        else if (Character.toString(taxBand).matches("N"))
        {
